...
class CoolGen_V8B(nn.Module):
    ...
    class UnetBlock(nn.Module):
        def __init__(self,in_nc, inner_nc, out_nc, num_truck_blocks, att_type, inner_block):
            ...
            self.truck1 = CoolGen_V8.Truck_GDW(num_blocks=num_truck_blocks, base_nc=inner_nc, att_type=att_type)
            self.inner_block = inner_block
            self.truck2 = CoolGen_V8.Truck_GDW(num_blocks=num_truck_blocks, base_nc=inner_nc, att_type=att_type)
